...
const TASK_STATUSES: DropdownItemsProps[] = [
  { label: "To Do", Icon: Circle, iconColor: "text-gray-600" },
  { label: "In Progress", Icon: CheckCircle, iconColor: "text-orange-600" },
  { label: "Done", Icon: XCircle, iconColor: "text-green-600" },
  { label: "In Review", Icon: RefreshCw, iconColor: "text-blue-600" },
  { label: "Backlog", Icon: List, iconColor: "text-gray-600" },
];
